...
<body>
    ...
    <script>
        ...
        /*
          Javascript code is largely made of code given to developers using the HERE map API.
          Notable references include adding markers to the map, geolocation and geocoding.
          https://developer.here.com/documentation/examples/maps-js
        */

        //Declare global variables to be used throughout program
        var marker;
        ...
        //Function that uses geolocation if device is available, passes map as parameter
        ...
        function showPosition(position) {
            ...
            var listAddress = "<?php echo $list; ?>";   //get list of a addresses from the PHP loop

            var Arr = listAddress.split(',');  //Split the locations by commma

            //Geocode each individual location
            for (i = 1; i < Arr.length; i++) {
                geocode(Arr[i]);
            }
        }

        //Function used to restrict map view to only show the USA, passes map as parameter
        ...
        //Function used to start geocoding process, passes location (text) as parameter
        function geocode(text) {
         ...
         //onSuccess called if theres a response from the HERE api.
        function onSuccess(result) {
            var locations = result.response.view[0].result;

            //Call functions to add location of marker to map and panel
            addLocationsToMap(locations);
            addLocationsToPanel(locations);
        }

        //onError is called if theres a problem reaching the HERE server
        ...
        //Opens or closes an info bubble, position is bubble position on map, text is content of bubble
        ...
        //Makes list of node items and adds them to the panel, each location as a parameter
        ...
        //Make a map marker for each location
        function addLocationsToMap(locations) {
            ...
            for (i = 0; i < locations.length; i += 1) {
                ...
                //Only add marker to the map if its within the range of the user location
                if (range > distance) {
        ...
        //Restrict the bounds of the map
        restrictMap(map);
